    ...
    static var mockedTasks: [Task] {
        return [
            Task(title: "Your favorite local restaurant",
                 description: "Where is the one restaurant you love to go to?"),
            Task(title: "Your favorite local cafe",
                 description: "Where do you go to get your coffee regularly?"),
            Task(title: "Your go-to brunch place",
                 description: "Where do you go for that morning snack you need to keep you going?"),
